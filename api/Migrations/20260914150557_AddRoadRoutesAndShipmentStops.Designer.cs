...
namespace FleetManagement.Api.Migrations
{
    ...
    [Migration("20260914150557_AddRoadRoutesAndShipmentStops")]
    partial class AddRoadRoutesAndShipmentStops
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FleetManagement.Api.Domain.TripPosition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FleetManagement.Api.Domain.TripPosition", b =>
                {
                    b.HasOne("FleetManagement.Api.Domain.Trip", "Trip")
                        .WithMany("Positions")
